...
-- Tiempo de generación: 08-06-2024 a las 21:04:26
...
--
-- Base de datos: `encantoaccesorios`
--
...
CREATE TABLE `clientes` (
  `id` int NOT NULL,
  `cedula` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT '',
...
(39, '1056', 'ce', NULL, 'c', NULL, NULL, '7', '1', '', '');
...
CREATE TABLE `imagenes_productos` (
  `id` int NOT NULL,
  `nombre_imagen` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(49, 'ce', '39', 'cezar_mh86@hotmail.com', NULL, '$2y$10$iqr30jFF2yrr1KpCMsBiG.DyPHkD0tB1.P0v/fYm7Mixq/O14KBlu', 'UpZb6uXTyAtC7e9o4SnF77gWOpXj94fO5AES2xx6R5jdXSbVpdO8mfvux8hJ', '2024-06-08 02:04:56', '2024-06-08 02:04:56');
...
CREATE TABLE `movimientos_caja` (
  `id` int NOT NULL,
  `fecha` date NOT NULL,
  `tipo_movimiento` enum('Ingreso','Retiro') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `valor` int NOT NULL,
...
INSERT INTO `movimientos_caja` (`id`, `fecha`, `tipo_movimiento`, `valor`, `usuario`, `observacion`) VALUES
(1, '2024-04-17', 'Ingreso', 5000, 1, NULL),
(2, '2024-04-17', 'Retiro', 1000, 1, NULL);
...
CREATE TABLE `productos` (
  ...
  `publicacionweb` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `proveedor` int NOT NULL,
...
INSERT INTO `proveedores` (`id`, `nombre`, `descripcion`, `direccion`, `telefono`, `email`) VALUES
(10, 'Proveedor 1', NULL, NULL, NULL, NULL);
...
(1, 'Usuario', 'ejemplo@gmail.com', NULL, '$2y$10$4Yx2bVhRByidnmrJkvmMReTvDqj6dyoRUqpwuW9E9orTBkb1WLLOq', '8OYaPMzLAzqzSQQ0sdwKqAbvQdP9rub23uLpI7PjJyBXSXFE2zoqYvpga3ZM', '2024-04-17 19:47:11', '2024-04-17 19:47:11');
