                ...
                <div style={{ marginBottom: '1em' }} align="center" className="row justify-content-center">
                    <div className="row">
                        <div style={{ textAlign: 'left', marginTop: '0.8em' }} className="col-lg-3 col-md-6 col-sm-12 col-12" >
                            <a href={route('promo.create')} style={{ color: 'black' }} className='btn bg-green-700 hover:bg-green-400 btn-sm'>Ingresar imagen a carrusel</a>
                        </div>
                            ...
                            promos.map((item, index) => {
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td>{item.infoProducto ? 'Producto: '+item.infoProducto.nombre : 'Categoria: '+item.infoCategoria.nombre}</td>
                                        <td>
